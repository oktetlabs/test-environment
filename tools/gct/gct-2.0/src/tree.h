...
/*** gct ***/
#define DECL_GCT_FLAVOR(NODE) ((NODE)->decl.gct_flavor)
#define DECL_GCT_SHADOWED(NODE) ((NODE)->decl.gct_shadowed)
...
struct tree_decl
{
  ...
  /*** GCT ***/
  char *gct_flavor;           /* GCT: Parms, vars, and fields. */
  int gct_shadowed;           /* GCT: Shadowed by later decl--see gct-tutil.c*/
  /* Points to a structure whose details depend on the language in use.  */
