...
enum attr_type {TYPE_MOVE, TYPE_UNARY, TYPE_BINARY, TYPE_COMPARE, TYPE_LOAD, TYPE_STORE, TYPE_UNCOND_BRANCH, TYPE_BRANCH, TYPE_CBRANCH, TYPE_FBRANCH, TYPE_CALL, TYPE_DYNCALL, TYPE_FPLOAD, TYPE_FPSTORE, TYPE_FPALU, TYPE_FPCC, TYPE_FPMUL, TYPE_FPDIVSGL, TYPE_FPDIVDBL, TYPE_FPSQRTSGL, TYPE_FPSQRTDBL, TYPE_MULTI, TYPE_MISC, TYPE_MILLI};
...
#define HAVE_ATTR_in_nullified_branch_delay
enum attr_in_nullified_branch_delay {IN_NULLIFIED_BRANCH_DELAY_FALSE, IN_NULLIFIED_BRANCH_DELAY_TRUE};
extern enum attr_in_nullified_branch_delay get_attr_in_nullified_branch_delay ();
...
#define MAX_READY_COST 18
#define MIN_ISSUE_DELAY 1
#define MAX_ISSUE_DELAY 18
#define MIN_BLOCKAGE 1
#define MAX_BLOCKAGE 18
#define BLOCKAGE_BITS 6
