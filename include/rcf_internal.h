...
typedef struct rcf_msg {
    ...
    char  value[RCF_MAX_VAL]; /**< Value of the variable or object instance */
    ...
    char  data[0];            /**< Start of additional for commands:
                                   ...
                                   RCFOP_START and RCFOP_EXECUTE (parameters);
