...
/** @page test_intersect Trivial test for checking TRC.
 *
 * @objective Check distributed TRC when merged iterations intersect with
 *            existing ones.
 *
...
#define TE_TEST_NAME "distributed/test_intersect"
