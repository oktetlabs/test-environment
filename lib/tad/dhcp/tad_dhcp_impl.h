 ...
 */ 
extern char* dhcp_get_param_cb (csap_p csap_descr, int level, const char *param);
 ...
 */ 
extern int dhcp_write_cb(csap_p csap_descr,
 ...
 * @return zero on success or error code.
 */ 
extern int dhcp_single_destroy_cb (int csap_id, int layer);
