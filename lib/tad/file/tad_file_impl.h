 ...
 *
 * Copyright (C) 2003 Test Environment authors (see tad_file AUTHORS
 ...
 */ 
extern int tad_file_read_cb(csap_p csap, int timeout,
 ...
 */ 
extern te_errno tad_file_write_cb(csap_p csap, const tad_pkt *pkt);
 ...
 */ 
extern int tad_file_write_read_cb(csap_p csap, int timeout,
                                  const tad_pkt *w_pkt,
 ...
 */ 
extern te_errno tad_file_single_init_cb(csap_p           csap,
                                        unsigned int     layer,
 ...
 */ 
extern te_errno tad_file_single_destroy_cb(csap_p       csap,
                                           unsigned int layer);
 ...
 */ 
extern te_errno tad_file_gen_bin_cb(csap_p                csap,
                                    unsigned int          layer,
 ...
 */
extern int tad_file_match_bin_cb(csap_p           csap,
                                 unsigned int     layer,
