...
enum tarpc_pktmbuf_ol_flags {
    ...
    TARPC_RTE_MBUF_F_RX_IP_CKSUM_NONE,
    TARPC_RTE_MBUF_F_RX_L4_CKSUM_BAD,
    TARPC_RTE_MBUF_F_RX_L4_CKSUM_GOOD,
    TARPC_RTE_MBUF_F_RX_L4_CKSUM_NONE,
...
enum tarpc_dev_rx_offload_bits {
    ...
    TARPC_RTE_DEV_RX_OFFLOAD_KEEP_CRC_BIT,
    TARPC_RTE_DEV_RX_OFFLOAD_SCTP_CKSUM_BIT,
    TARPC_RTE_DEV_RX_OFFLOAD_OUTER_UDP_CKSUM_BIT,
    TARPC_RTE_DEV_RX_OFFLOAD_RSS_HASH_BIT,
...
enum tarpc_dev_tx_offload_bits {
    ...
    TARPC_RTE_DEV_TX_OFFLOAD_UDP_TNL_TSO_BIT,
    TARPC_RTE_DEV_TX_OFFLOAD_IP_TNL_TSO_BIT,
    TARPC_RTE_DEV_TX_OFFLOAD_OUTER_UDP_CKSUM_BIT,
    TARPC_RTE_DEV_TX_OFFLOAD_MATCH_METADATA_BIT,
