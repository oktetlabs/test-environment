...
#ifdef PKT_TX_OUTER_UDP_CKSUM
    RTE_PKTMBUF_OL_FLAGS2RPC(PKT_TX_OUTER_UDP_CKSUM);
#endif /* PKT_TX_OUTER_UDP_CKSUM */
    RTE_PKTMBUF_OL_FLAGS2RPC(PKT_TX_TUNNEL_VXLAN);
    RTE_PKTMBUF_OL_FLAGS2RPC(PKT_TX_TUNNEL_GENEVE);
    RTE_PKTMBUF_OL_FLAGS2RPC(PKT_TX_TUNNEL_GRE);
...
#define RTE_PKTMBUF_OL_FLAGS2RTE(_bit) \
    ...
    RTE_PKTMBUF_OL_FLAGS2RTE(PKT_RX_OUTER_IP_CKSUM_BAD);
#ifdef PKT_RX_OVERSIZE
...
#ifdef PKT_TX_OUTER_UDP_CKSUM
    RTE_PKTMBUF_OL_FLAGS2RTE(PKT_TX_OUTER_UDP_CKSUM);
#endif /* PKT_TX_OUTER_UDP_CKSUM */
    RTE_PKTMBUF_OL_FLAGS2RTE(PKT_TX_TUNNEL_VXLAN);
    RTE_PKTMBUF_OL_FLAGS2RTE(PKT_TX_TUNNEL_GENEVE);
    RTE_PKTMBUF_OL_FLAGS2RTE(PKT_TX_TUNNEL_GRE);
