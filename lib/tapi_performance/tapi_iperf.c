 ...
 */
static void
set_opt_length(te_string *cmd, const tapi_iperf_options *options)
{
    if (options->client.length != TAPI_IPERF_OPT_LENGTH_DEFAULT)
 ...
 */
static void
set_opt_reverse(te_string *cmd, const tapi_iperf_options *options)
{
