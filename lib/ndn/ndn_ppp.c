...
static asn_type ndn_pppoe_pkt_s = {
    "PPPoE-Message", {PRIVATE, NDN_PPPOE_PKT}, SEQUENCE,
...
asn_type * ndn_pppoe_csap = &ndn_pppoe_csap_s;
...
asn_type * ndn_ppp_csap = &ndn_ppp_csap_s;
