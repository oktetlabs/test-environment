...
typedef enum {
    ...
    NDN_FLOW_ACTION_TYPE_VF,
    NDN_FLOW_ACTION_TYPE_PHY_PORT,
...
typedef enum {
    ...
    NDN_FLOW_ACTION_CONF_ID_ORIGINAL,
    NDN_FLOW_ACTION_CONF_IO_ID,
    NDN_FLOW_ACTION_CONF_IO_ORIGINAL,
    NDN_FLOW_ACTION_CONF_PORT_ID,
    NDN_FLOW_ACTION_CONF_VF,
    NDN_FLOW_ACTION_CONF_PHY_PORT,
