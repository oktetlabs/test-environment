                  ...
                  char *diag, int diag_len)
{
    ...
    rcf_rpc_call(rpcs, "aio_read_test", &in, &out);
                   ...
                   char *diag, int diag_len)
{
    ...
    rcf_rpc_call(rpcs, "aio_error_test", &in, &out);
                   ...
                   char *diag, int diag_len)
{
    ...
    rcf_rpc_call(rpcs, "aio_write_test", &in, &out);
                     ...
                     char *diag, int diag_len)
{
    ...
    rcf_rpc_call(rpcs, "aio_suspend_test", &in, &out);
