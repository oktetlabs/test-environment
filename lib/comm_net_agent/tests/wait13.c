...
#define COMMAND_SIZE            ((TOTAL_BUFFER_LENGTH / 3) * 3)
...
/** @page test_rcf_net_agent_wait13 test_rcf_net_agent_wait() triple call border value check, no attachment
 *
 * @descr The remote stations issues a message consisting of a command exactly
 * three times as long as the input buffer. The first call and the
