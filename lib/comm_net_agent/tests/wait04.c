...
/** @page test_rcf_net_agent_wait04 test_rcf_net_agent_wait() normal buffer check, with attachment
 *
 * @descr The remote station issues a message consisting of a command and 
 * attachment which totally fit into one input buffer. The function
 * @b rcf_comm_agent_wait() must return the original message sent
