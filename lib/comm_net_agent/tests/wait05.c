...
#define DECLARED_BUFFER_LENGTH  ((TOTAL_BUFFER_LENGTH / 3) * 3)

#define TEST_BUFFER_SANITY()                                            \
    do {                                                          \
        if (DECLARED_BUFFER_LENGTH != MESSAGE_SIZE ||                       \
...
/** @page test_rcf_net_agent_wait05 test_rcf_net_agent_wait() buffer border value check, with attachment
 *
