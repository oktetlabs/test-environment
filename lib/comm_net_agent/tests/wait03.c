...
#define COMMAND_SIZE            TOTAL_BUFFER_LENGTH
...
/** @page test_rcf_net_agent_wait03 test_rcf_net_agent_wait() buffer border value check, no attachment
 *
 * @descr The remote station issues a message consisting of a command exactly 
 * of the same size as the input buffer. The function @b rcf_comm_agent_wait()  * must return the entire message.
 *
