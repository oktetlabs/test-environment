...
/* See description in rcf_ch_api.h */
int 
rcf_ch_csap_create(char *cbuf, int buflen, char *ba, int cmdlen, 
                   struct rcf_comm_connection *handle, 
                   int answer_plen, char *stack, char *params)
{
    UNUSED(cbuf);
    UNUSED(buflen);
    UNUSED(ba);
...
/* See description in rcf_ch_api.h */
int 
rcf_ch_csap_destroy(char *cbuf, int buflen,
                    struct rcf_comm_connection *handle, 
                    int answer_plen, int csap)
{
    UNUSED(cbuf);
    UNUSED(buflen);
    UNUSED(handle);
...
/* See description in rcf_ch_api.h */
int 
rcf_ch_csap_param(char *cbuf, int buflen, int cmdlen, 
                  struct rcf_comm_connection *handle, 
                  int answer_plen, int csap, char *param)
{
    UNUSED(cbuf);
    UNUSED(buflen);
    UNUSED(cmdlen);
...
/* See description in rcf_ch_api.h */
int 
rcf_ch_trsend_start(char *cbuf, int buflen, char *ba, int cmdlen, 
                    struct rcf_comm_connection *handle, 
                    int answer_plen, int csap, int postponed)
{
    UNUSED(cbuf);
    UNUSED(buflen);
    UNUSED(ba);
...
/* See description in rcf_ch_api.h */
int 
rcf_ch_trsend_stop(char *cbuf, int buflen, 
                   struct rcf_comm_connection *handle, 
                   int answer_plen, int csap)
{
    UNUSED(cbuf);
...
/* See description in rcf_ch_api.h */
int 
rcf_ch_trrecv_start(char *cbuf, int buflen, char *ba, int cmdlen, 
                    struct rcf_comm_connection *handle, int answer_plen, 
                    int csap, int postponed, int num, int results,
...
/* See description in rcf_ch_api.h */
int 
rcf_ch_trrecv_stop(char *cbuf, int buflen, 
                   struct rcf_comm_connection *handle, 
                   int answer_plen, int csap)
{
    UNUSED(cbuf);
...
/* See description in rcf_ch_api.h */
int 
rcf_ch_trrecv_get(char *cbuf, int buflen, 
                  struct rcf_comm_connection *handle, 
                  int answer_plen, int csap)
{
    UNUSED(cbuf);
...
/* See description in rcf_ch_api.h */
int 
rcf_ch_trsend_recv(char *cbuf, int buflen, char *ba, int cmdlen,
                   struct rcf_comm_connection *handle, 
                   int answer_plen, int csap, int results, int timeout)
{
    UNUSED(cbuf);
    UNUSED(buflen);
    UNUSED(ba);
