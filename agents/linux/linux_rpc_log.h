 ...
 *
 * $Id: linux_rpc.h 2620 2004-06-23 16:33:16Z arybchik $
 */
 
#ifndef __LINUX_RPC_LOG_H__
#define __LINUX_RPC_LOG_H__
...
#define RPC_LGR_MESSAGE(_lvl, _fs...) \
    do {                                                                \
        ...
        if (((_lvl) & LOG_LEVEL) == 0)                                  \
            break;                                                      \
                                                                        \
        if ((_s = socket(AF_UNIX, SOCK_DGRAM, 0)) < 0)                  \
            break;                                                      \
                                                                        \
        *(uint16_t *)_str = _lvl;                                       \
